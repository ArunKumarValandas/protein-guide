...
import { GREEDY_ALGO_LIST } from '@/constants/greedy';
...
export function GreedyPage() {
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-content">Greedy Algorithms</h1>
        <p className="mt-2 text-content-muted">
          Visualize local optimal choices and when they lead to global optima.
        </p>
      </div>

      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {GREEDY_ALGO_LIST.map((algorithm) => (
          <Link key={algorithm.id} to={`${ROUTES.GREEDY}/${algorithm.id}`}>
